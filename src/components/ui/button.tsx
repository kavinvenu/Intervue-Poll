  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        pill: "bg-primary text-primary-foreground hover:bg-primary/90 active:scale-[0.98] rounded-full",
        "pill-outline": "border-2 border-primary text-primary bg-transparent hover:bg-primary/10 rounded-full",
        "pill-secondary": "bg-primary/90 text-primary-foreground hover:bg-primary rounded-full",
      },
      size: {
        ...
        "pill-lg": "h-14 px-12 py-4 text-base",
      },
    },
    defaultVariants: {
      variant: "default",
